...
class MarcaController extends Controller
{
    ...
    public function store(StoreCaracteristicaRequest $request)
    {
        ...
        return redirect()->route('admin.marca.index')->with('success', 'Marca registrada');
    }
    ...
    {
        return view('admin.marca.edit', ['categoria' => $marca]);
    }
    ...
    return redirect()->route('admin.marca.index')->with('success', 'marca editada');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.marca.index')->with('success', $message);
    }
}
